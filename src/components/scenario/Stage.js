//1 - saber as informaçãoes de quem está lutando
//(qual id que tem as informações do char 1 ou char 2)
...
class Stage {
    ...
    doAttack(attcking, attacked) {
      console.log(`${attcking.name} esta atacando ${attacked.name}!`)
